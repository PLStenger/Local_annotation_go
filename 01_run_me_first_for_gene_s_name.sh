...
echo "#! /bin/bash " >> 02_run_me_second.sh
...
echo '#! /bin/bash' >> 03_run_me_third_prep.sh
...
echo 'grep -E XXXX^DEXXXX ${FILE##*/} | sed XXXXs/DE   //gXXXX | sed XXXXN;s/;\n/\; /gXXXX >> ${FILE##*/}_2.txt' >> 03_run_me_third_prep.sh
...
echo 'awk XXXX{$1=""; print $0}XXXX  ALL_6.txt > ALL_7.txt' >> 03_run_me_third_prep.sh
...
echo 'paste ALL_10.txt ALL_8.txt > annotation_gene_named.txt' >> 03_run_me_third_prep.sh
echo 'rm ALL*' >> 03_run_me_third_prep.sh
echo 'rm *_2.txt' >> 03_run_me_third_prep.sh
echo 'rm *_3.txt' >> 03_run_me_third_prep.sh
